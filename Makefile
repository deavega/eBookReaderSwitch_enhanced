...
LIBS_REAL = mupdf mupdf-third stdc++fs SDL2_ttf SDL2_image png jpeg freetype harfbuzz webp z bz2 config nx
...
# include and lib
#---------------------------------------------------------------------------------
LIBDIRS	:= $(PORTLIBS) $(LIBNX) $(CURDIR)/mupdf $(CURDIR)/mupdf/build/release

...
void Init_Services() {
    ...
    std::cout << "Initialize Services" << std::endl;

    romfsInit();
    std::cout << "Initialized RomFs" << std::endl;
    ...
    std::cout << "Retrieved Fonts" << std::endl;
